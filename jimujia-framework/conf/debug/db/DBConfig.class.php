...
class DBConfig {
    ...
    * 主库
    */
    const COMMON_MASTER_HOST     = 'git.miaowudz.com';
    ...
    * 从库
    */
    const COMMON_SLAVE_HOST     = 'git.miaowudz.com';
    ...
    * 论坛数据库
    */
    const COMMON_FORUM_HOST     = '127.0.0.1';
    const COMMON_FORUM_USERNAME = 'root';
    const COMMON_FORUM_PASSWD   = 'sa';
     ...
     * 蘑菇装修 主库
     */
    const COMMON_MASTER_MARIO_HOST     = 'git.miaowudz.com';
     ...
     * 蘑菇装修 从裤
     */
    const COMMON_SLAVE_MARIO_HOST     = 'git.miaowudz.com';
    ...
    */
    ...
    const COMMON_SLAVE_MARIO_FORUM_USERNAME = 'root';
    const COMMON_SLAVE_MARIO_FORUM_PASSWD   = 'sa';
    ...
    */
    ...
    const COMMON_SLAVE_MARIO_WP_USERNAME = 'root';
    const COMMON_SLAVE_MARIO_WP_PASSWD   = 'sa';
    ...
    * 微信数据库
    */
    const COMMON_WECHAT_HOST     = '192.168.199.182';
    const COMMON_WECHAT_USERNAME = 'www';
    const COMMON_WECHAT_PASSWD   = 'w123456';
    ...
    */
    ...
    const COMMON_CUSTOM_USERNAME = '51zx_custom';
    const COMMON_CUSTOM_PASSWD   = 'c123456';
