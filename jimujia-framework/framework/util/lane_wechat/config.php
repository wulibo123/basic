 ...
 */
define("WECHAT_URL", 'http://mp.51zx.com/index.php?m=MGIndex');
define('WECHAT_TOKEN', 'MUSHROOM');
define('ENCODING_AES_KEY', "fhvWRXVRhDiLMW550k8FTmHZSuPQ3YX1DdylYaTGSFI");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wx86c96a314855023f');
define("WECHAT_APPSECRET", '16c9f00b6c456cfa3da0e687dfbce037');
//define("WECHAT_APPID", 'wxff12383ea95500c4');
//define("WECHAT_APPSECRET", '4d5da5b3ba95b877475cf3cffd848f44');
